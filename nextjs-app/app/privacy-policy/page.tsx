...
export const metadata: Metadata = {
  title: 'Privacy Policy | Bridal Aisle Boutique',
  description: 'Privacy Policy for Bridal Aisle Boutique. Learn how we collect, use, and protect your personal information.',
  alternates: {
    ...
    <main className="page-container">
      <section className="privacy-policy-section">
        <div className="privacy-policy-container">
          ...
          <p className="privacy-updated">Last updated: November 21, 2025</p>
          ...
          <ul>
            ...
            <li><strong>Website</strong> refers to Bridal Aisle Boutique, accessible from <a href="https://bridalaisle.com/">https://bridalaisle.com/</a></li>
          ...
          <ul>
            <li>By email: <a href="mailto:info@bridalaislemn.com">info@bridalaislemn.com</a></li>
          </ul>
        </div>
      </section>
    </main>
